  ...
  async function createContent(event) {
    try {
      ...
      await ContentsApi().createContent(
        req.titulo.value, req.descricao.value, req.posicao.value
      ).then(data => {
        return data.json()
      }).then(res => {
  ...
  async function updateContent(event) {
    try {
      ...
      await ContentsApi().updateContent(
        selectedContent.id, req.titulo.value, req.descricao.value, req.posicao.value
      )
